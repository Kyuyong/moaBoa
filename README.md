  ...
  ![Downloads](https://img.shields.io/github/downloads/Kyuyong/moaBoa/total?style=flat&label=Downloads&color=brightgreen) 
  ...
  **Moaboa**는 이 과정을 자동화합니다.
  ...
  👉 [Moaboa.dmg 다운로드](https://github.com/Kyuyong/moaBoa/releases/latest)

  1. DMG 파일 다운로드
  2. 더블클릭 후 Applications 폴더로 드래그
  3. 처음 실행 시 우클릭 → 열기 클릭
